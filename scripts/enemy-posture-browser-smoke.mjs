...
try {
  ...
  if (!dom.includes('data-enemy-posture-renderer-sequence="neutral-pressure-telegraph-suppressed-guard-break"')) throw new Error('Enemy-posture renderer contract did not complete the intended pressure lifecycle');
  ...
  console.log(`enemy-posture browser smoke passed with ${browser}: 320x568 real PlayCanvas pressured guard + telegraph suppression + guard-break read`);
} finally {
