...
- Optional direct **練浪人 / 練鬼 / 練將軍** practice launches the unchanged real Stage 2 / Stage 3 / Stage 4 definitions. Each route ends after the selected duel, supports immediate same-opponent retry or return to the full campaign, renders opponent-specific practice results, and never writes campaign personal best. 練鬼 is the real Oni Guard (8 HP / posture 5 / existing heavy attacks); no practice-only balance copy exists.
...
- Result cards give one stage-focused tip; Ronin/Oni/Shogun practice results are explicitly opponent-labelled and excluded from campaign best. Better campaign victories may replace local best; worse runs and practice do not.
...
- The production start-layout gate covers the five-entry practice/challenge selector (**練浪人 / 練鬼 / 練將軍 / 連戰試煉 / 今日陣**) inside the same 320×568 viewport. The mastery browser harness separately clicks all three direct practice entries through terminal retry/campaign handoff, while deterministic Node coverage proves each route uses the unchanged real Stage 2/3/4 definition.
