...
- [ ] Focused 320×568 今日陣/challenge tactical gate completes real Waves 2/4/6 choices, requires terminal **戰策回顧** text `戰策 · 2誓 · 4息 · 6誓 · +700分 · 生命-1` for the deterministic test route, keeps the recap bounding rectangle inside the challenge-result surface and viewport, then proves retry and full-campaign handoff clear the recap text/state.
