...
- [ ] Blocked localStorage is non-fatal for all local preferences/best-run state.
...
- [ ] Ashigaru → Ronin → Oni → Crimson Shogun progression remains intact; stage transition/restart resets combat state and distance.
