...
2. **Ronin/Oni/Shogun/Blood Moon repeated practice evidence** — use real Stage 2/3/4 Phase I/direct Phase II practice plus local stage analysis to separate feint reading, Oni heavy-attack pressure, missed counters, STEP misuse, raw timing pressure, Phase I load and Blood Moon pressure before changing campaign balance.
