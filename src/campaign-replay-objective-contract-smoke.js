...
try {
  ...
  const firstLine = document.querySelector('[data-campaign-replay-objective]');
  ...
  const achievedLine = document.querySelector('[data-campaign-replay-objective]');
  ...
  const quietLine = document.querySelector('[data-campaign-replay-objective]');
