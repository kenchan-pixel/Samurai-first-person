...
function ensureStyles() {
  ...
  style.textContent = `
    ...
    html[data-control-hand="right"] .footwork-step{left:auto!important;right:calc(var(--safe-right) + 8px)!important;transform:none!important}
    html[data-control-hand="right"] .footwork-step:active,html[data-control-hand="right"] .footwork-step.is-active{transform:scale(.94)!important}
    html[data-control-hand="right"] .footwork-range{left:auto!important;right:calc(var(--safe-right) + 12px)!important;transform:none!important}
    html[data-control-hand="right"] .footwork-feedback{left:auto!important;right:calc(var(--safe-right) + 8px)!important;transform:translateY(5px)!important}
    html[data-control-hand="right"] .footwork-feedback.is-visible{transform:translateY(0)!important}
    ...
    @media(max-width:360px){
      ...
      html[data-control-hand="right"] .footwork-step{right:calc(var(--safe-right) + 4px)!important}
      html[data-control-hand="right"] .footwork-range{right:calc(var(--safe-right) + 8px)!important}
      html[data-control-hand="right"] .footwork-feedback{right:calc(var(--safe-right) + 5px)!important}
